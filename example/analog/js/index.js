...
var app = {
    ...
    setup: function() {
        ...
        var didInit = function() {
            bleFirmata.pinMode(POTENTIOMETER_PIN, 'ANALOG', didSetupPins, function(err){console.log('pinMode Failed');});
        };
    ...
    loop: function() {
        ...
        var readPo = function(value) {
            ...
            // bleFirmata.digitalWrite(LED_PIN, value);
        };
        
        bleFirmata.analogRead(POTENTIOMETER_PIN, readPo, function(err){console.log('readSwitch Failed');});
    }
};